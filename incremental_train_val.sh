...
bash dist_train.sh configs/ov_coco/cat_seg_2d_pseudolabel/catseg_mask_task4.py 8 --work-dir runs/cat-seg/test_train_task4_10_2d_decouple_distill_pseudo_label
