...
bash dist_train.sh configs/ov_coco/cat_seg_2d_pseudolabel/catseg_mask_task2.py 6 --work-dir runs/cat-seg/test_train_task2_10_2d_decouple_distill_all_pseudo_label
