...
class CocoDatasetOV(CocoDataset):
    def __init__(self,
                 ann_file,
                 pipeline,
                 seen_classes='/hy-tmp/liuzihan/CLIPSelf/F-ViT/datasets/mscoco_seen_classes.json',
                 unseen_classes='/hy-tmp/liuzihan/CLIPSelf/F-ViT/datasets/mscoco_unseen_classes.json',
                 all_classes='/hy-tmp/liuzihan/CLIPSelf/F-ViT/datasets/mscoco_65_classes.json',
                 **kwargs):
