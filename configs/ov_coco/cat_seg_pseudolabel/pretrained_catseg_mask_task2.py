...
model = dict(
    ...
    old_cfg='/mnt/data14/yyg/F-ViT/configs/ov_coco/cat_seg_pseudolabel/pretrained_catseg_mask.py',
    old_ckpt="runs/cat-seg/test_train_task1_pseudo_label/epoch_15.pth",
    use_feature_routing=True,
    old_end=19,
    backbone=dict(
        type='CATSegCLIPViT',
        config_path='/mnt/data14/yyg/CAT-Seg/configs/vitb_384.yaml',
        checkpoint_path=None,
        class_json_path='datasets/incremental_classes/task12_classes.json',
...
log_level = 'INFO'
load_from = 'runs/cat-seg/test_train_task1_pseudo_label/epoch_15.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/data14/yyg/F-ViT/train_task2_with_pseudo_labels.json',
