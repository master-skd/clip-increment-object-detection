...
model = dict(
    ...
    backbone=dict(
        ...
        class_json_path='datasets/incremental_classes/task1_classes.json',
    ...
    roi_head=dict(
        ...
        #     type='SingleRoIExtractor',
        #     roi_layer=dict(type='RoIAlign', output_size=7, sampling_ratio=0),
        #     out_channels=1, # 这里的 out_channels 只是占位，RoIAlign 不会检查动态输入的通道数
        #     featmap_strides=[16]
        # ), # 必须改成你 Cost Volume 实际的 stride (如 CLIP res4 是 16)
        bbox_head=dict(
