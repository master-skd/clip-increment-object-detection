...
model = dict(
    ...
    old_cfg='/mnt/data14/yyg/F-ViT/configs/ov_coco/cat_seg_3d_pseudolabel/catseg_mask.py',
    old_ckpt='runs/cat-seg/test_train_task1_3d_pseudo_label/epoch_40.pth',
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            k_dim=select_classes,        # 固定 top-k（pad_len），pool_k=False 时必须提供
...
log_level = 'INFO'
load_from = 'runs/cat-seg/test_train_task1_3d_pseudo_label/epoch_40.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file='/mnt/data14/yyg/datasets/Incremental/train_task_2.json',
        ann_file='/mnt/data14/yyg/F-ViT/train_task2_with_pseudo_labels_3d.json',
