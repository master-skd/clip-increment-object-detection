...
log_level = 'INFO'
load_from = 'runs/incremental/ViT-L-16-SigLIP2-512/train_task1/latest.pth' # 从task1训练好的模型加载权重
# load_from = '/hy-tmp/liuzihan/CLIPSelf/F-ViT/train_task1/latest.pth' # 从task1训练好的模型加载权重
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/hy-tmp/liuzihan/datasets/Incremental/0/train_task_2.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/hy-tmp/liuzihan/datasets/Incremental/0/test_task_12.json',
