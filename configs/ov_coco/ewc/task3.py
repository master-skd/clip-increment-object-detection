...
model = dict(
    type='FViT',
    fisher_path='fisher_task2_fvit_neck.pth',
    prev_model_path='runs/cat-seg/ablation_moe/test_train_task2_10_2d_moe_sigmoid/epoch_3.pth',
    backbone=dict(
...
log_level = 'INFO'
load_from = 'runs/cat-seg/ablation_moe/test_train_task2_10_2d_moe_sigmoid/epoch_3.pth' # 上一次任务的模型权重
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/mnt/data14/yyg/datasets/Incremental/train_task_3.json',
