...
log_level = 'INFO'
load_from = 'runs/cat-seg/test_train_task1/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=
        '/data1/lzh/datasets/Incremental/train_task_2.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/data1/lzh/datasets/Incremental/test_task_12.json',
