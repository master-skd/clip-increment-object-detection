...
model = dict(
    ...
    backbone=dict(
        ...
        class_json_path='datasets/incremental_classes/task123_classes.json',
...
log_level = 'INFO'
load_from = 'runs/cat-seg/test_train_task2/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=
        '/data1/lzh/datasets/Incremental/train_task_3.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/data1/lzh/datasets/Incremental/test_task_123.json',
